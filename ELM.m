function [T,TVT,P,TVP,Y,TY] = ELM(TrainingData_File, TestingData_File, Elm_Type, NumberofHiddenNeurons, ActivationFunction)
...
T=train_data(:,1)';
P0=train_data(:,2:size(train_data,2));
P=preprocess(P0)';
...
TVT=test_data(:,1)';
TVP0=test_data(:,2:size(test_data,2));
TVP=tpreprocess(P0,TVP0)';
